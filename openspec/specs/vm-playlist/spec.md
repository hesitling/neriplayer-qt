...
Defines `PlaylistViewModel`, a QObject that aggregates playlists from local storage and NetEase for the library screen, with CRUD operations and selection signals.
