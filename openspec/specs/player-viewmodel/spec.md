...
Defines `PlayerViewModel`, a QObject that exposes playback state, controls, queue management, and error handling from `PlaybackController` as Q_PROPERTYs and Q_INVOKABLEs for QML binding.
