...
Defines `QtMultimediaBackend`, the default `IPlayerBackend` implementation using Qt6's `QMediaPlayer` and `QAudioOutput` for audio decoding and playback control.
