...
Defines `SearchViewModel`, a QObject that dispatches search queries to `IMusicPlatformPlugin` with debounce, pagination, request versioning, and result caching.
