...
Defines `PlaybackController`, the central playback orchestrator that manages URL resolution, backend delegation, auto-advance, queue integration, state persistence, and volume control.
