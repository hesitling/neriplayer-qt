...
Defines `NeteasePlaylistDetailViewModel`, a QObject that fetches and displays a NetEase playlist or album with batch-fetch support, local caching, and save-to-local functionality.
