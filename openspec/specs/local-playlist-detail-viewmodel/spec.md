...
Defines `LocalPlaylistDetailViewModel`, a QObject that loads, displays, and manages a single local playlist including song management, renaming, deletion, and play integration.
