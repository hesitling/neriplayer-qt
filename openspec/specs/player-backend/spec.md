...
Defines the `IPlayerBackend` abstract interface for audio playback backends, specifying load, play, pause, stop, seek, state queries, volume control, and signal contracts.
