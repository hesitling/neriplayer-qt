...
Defines `MainViewModel`, the root QObject that owns all child ViewModels, manages view navigation with a `View` enum, handles detail ViewModel lifecycle, and wires cross-VM signals.
